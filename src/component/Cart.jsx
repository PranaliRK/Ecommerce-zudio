            ...
            {cart.map((item)=>{
              return(
                <tr key={item.id}>
                  ...
                  <td>{item.title}</td>
                  <td><button className='inde' onClick={()=> handleButtonClick(item.id, 'increment')}>+</button></td>
                  <td>{item.amount}</td>
                  <td><button className='inde' onClick={()=> handleButtonClick(item.id, 'decrement')}>-</button></td>
                  <td>{item.price}</td>
                  <td><button className='delete' onClick={()=>handleRemove(item.id)}>Delete</button></td>
                </tr>
              )
            })}
          </tbody>
